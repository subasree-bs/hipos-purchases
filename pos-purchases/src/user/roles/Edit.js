        ...
        <Box>
            <form action=''>
                <Box sx={{ paddingTop: '10px' }}>
                    <Grid display="flex">
                        <Typography variant="h5" sx={{color:'#7009ab'}} >Edit Role</Typography>
                    </Grid>
                </Box><br />
                    ...
                    <Grid container spacing={2} sx={{
                        ...
                        <Grid item md={8}>
                            <Grid display="block">
                                ...
                                <Grid>
                                    <FormGroup>
                                        <span><FormControlLabel control={<Checkbox />} label="View Purchase price" /><Tooltip classes={{ arrow: classes.arrow,tooltip: classes.tooltip }}  arrow title="Permission to view purchase price in product details">
                                            <IconButton>
                                                <FcInfo />
                                            </IconButton>
                                        </Tooltip></span>
                        ...
                        <Grid item md={8}>
                            <Grid display="block">
                                ...
                                <Grid>
                                    <FormGroup>
                                        <span><FormControlLabel control={<Checkbox />} label="Add/Edit/Delete Payments" /><Tooltip classes={{ arrow: classes.arrow,tooltip: classes.tooltip }}  arrow title="Permission to Add/Edit/Delete Payments in List Purchases.">
                                            <IconButton>
                                                <FcInfo />
                                            </IconButton>
                                        </Tooltip></span>
