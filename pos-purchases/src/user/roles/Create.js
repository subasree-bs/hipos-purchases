        ...
        <Box>
            <form action=''>
                <Box sx={{ paddingTop: '10px' }}>
                    <Grid display="flex">
                        <Typography variant="h5" sx={{color:'#7009ab'}}>Add Role</Typography>
                    </Grid>
                </Box><br />
                <Box sx={userStyle.container}>
                    <Grid container spacing={2} sx={{
                        ...
                        <Grid item md={8}>
                            <FormGroup>
                                <span> <FormControlLabel control={<Checkbox />} label="Service staff" />
                                    <Tooltip classes={{ arrow: classes.arrow,tooltip: classes.tooltip }}  arrow title="Person who provides the designated service to customers Example: Waiting Staff in restaurants, Hairdressers in salon">
                                        <IconButton>
                                            <FcInfo />
                                        </IconButton>
                                    </Tooltip>
                        ...
                        <Divider sx={{ my: 2 }} />
                        <Grid item md={2}>
                            <Typography variant="body1" >Customer<Tooltip classes={{ arrow: classes.arrow,tooltip: classes.tooltip }}  arrow title="To view all customers with no sell from a specific time <b>View all customer permission is required otherwise it will filter with only cusromers created by the logged in user">
                                <IconButton>
                                    <FcInfo />
                                </IconButton>
                            </Tooltip></Typography>
                                ...
                                <Grid>
                                    <FormGroup>
                                        <span><FormControlLabel control={<Checkbox />} label="View Purchase price" />
                                            <Tooltip classes={{ arrow: classes.arrow,tooltip: classes.tooltip }}  arrow title="Permission to view purchase price in product details">
                                                <IconButton>
                                                    <FcInfo />
                                                </IconButton>
                                            </Tooltip>
                                ...
                                <Grid>
                                    <FormGroup>
                                        <span><FormControlLabel control={<Checkbox />} label="Add/Edit/Delete Payments" />
                                            <Tooltip classes={{ arrow: classes.arrow,tooltip: classes.tooltip }}  arrow title="Permission to Add/Edit/Delete Payments in List Purchases.">
                                                <IconButton>
                                                    <FcInfo />
                                                </IconButton>
                                            </Tooltip>
                        ...
                        <Divider sx={{ my: 2 }} />
                        <Grid item md={2}>
                            <Typography variant="body1" >Sell <Tooltip classes={{ arrow: classes.arrow,tooltip: classes.tooltip }}  arrow title="To view sells on the basis of payment status <b> View all sell permission is required otherwise it will filter with only sells created by the logged in user">
                                <IconButton>
                                    <FcInfo />
                                </IconButton>
                            </Tooltip></Typography>
                        ...
                        <Grid item md={8}>
                            <Grid display="block">
                                ...
                                <Grid>
                                    <FormGroup>
                                        <span><FormControlLabel control={<Checkbox />} label=" Add/Edit/Delete Payments " /><Tooltip classes={{ arrow: classes.arrow,tooltip: classes.tooltip }}  arrow title="Permission to Add/Edit/Delete Payments in List Sells / List POS screen.">
                                            <IconButton>
                                                <FcInfo />
                                            </IconButton>
                                        </Tooltip></span>
                        ...
                        <Divider sx={{ my: 2 }} />
                        <Grid item md={4}>
                            <Typography variant="body1" >Home <Tooltip classes={{ arrow: classes.arrow,tooltip: classes.tooltip }}  arrow title="If unchecked only Welcome message will be displayed in Home.">
                                <IconButton>
                                    <FcInfo />
                                </IconButton>
                            </Tooltip></Typography>
