...
const [purchaseReturnFilter, setPurchaseReturnFilter] = useState({BusinessLocation:"",})
                  ...
                  <Typography>
                    <FormControl sx={  purchaseList.selectFormcontrol } size="small" fullWidth >
                      ...
                      <Select
                        ...
                        value={purchaseReturnFilter.BusinessLocation}
                        label="Business Location"
                        onChange={(event) => {
                          setPurchaseReturnFilter({...purchaseReturnFilter, BusinessLocation: event.target.value})
                        }}
                      >
                ...
                {/* <Grid  item  md={3}  sm={6}  xs={10} sx={purchaseList.selectInput} >
                  ...
                  <FormControl sx={  purchaseList.selectFormcontrol } size="small" fullWidth >
                      ...
                      <Select
                        labelId="demo-select-small"
                        id="demo-select-small"
                        value={purchaseReturnFilter.Brand}
                        label="Brand"
                        onChange={(event) => {
                          setPurchaseReturnFilter({...purchaseReturnFilter, Brand: event.target.value})
                        }}
                      >
                        <MenuItem value="">All</MenuItem>
            ...
            <Container>            
                <Grid container spacing={10} sx={{ paddingTop: '15px' }}>
                    <Grid item md={6} sm={6} xs={6}>
                        <Typography variant="h6" >All Purchase Returns</Typography>
                    </Grid>
                    <Grid item md={6} sm={6} xs={6} >
