                    ...
                    <Grid item md={3} sm={6} xs={12}>
                        <FormControl size="small" fullWidth>
                            ...
                            <OutlinedInput
                                ...
                                label="Contact Id"
                                value={purchaseRetEdit.purchaseRetEditRefNo}
                                onChange={(event) => { setPurchaseRetEdit({ ...purchaseRetEdit, purchaseRetEditRefNo: event.target.value }) }}
                                type="date"
                            />
                        </FormControl>
                    </Grid>
                            ...
                            <Table aria-label="customized table" id="">
                                <TableHead >
                                    <StyledTableRow >
                                        ...
                                        <StyledTableCell align="center"><FaTrash /></StyledTableCell>
                                    </StyledTableRow>
                                </TableHead>
                                <TableBody>
                                    <StyledTableRow>
