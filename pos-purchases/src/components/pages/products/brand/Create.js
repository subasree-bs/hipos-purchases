...
import { FaDownload, FaFileCsv, FaPrint, FaFilePdf, FaEye, FaTrash } from 'react-icons/fa';
...
function Sellingrouplist() {
  return (
    <Box>
      ...
      <Box sx={userStyle.ImportContainer}>
