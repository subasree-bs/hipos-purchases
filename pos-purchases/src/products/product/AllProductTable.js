...
import { Typography,Checkbox,MenuItem, Grid, Box, Button,
   Menu,TableSortLabel,Tooltip,Avatar,Divider,Toolbar,Table,TableBody,
   TableCell,TableContainer,TableHead,TableRow,Paper,tableCellClasses} from "@mui/material";
...
import {  FaPrint, FaFilePdf, FaEdit, FaEye, FaTrash, 
  FaDatabase, FaHistory, FaCopy, FaBarcode,FaFileExcel,} from "react-icons/fa";
  ...
  const EnhancedTableToolbar = (props) => {
    ...
    return (
      ...
      >
        ...
        {numSelected > 0 ? (
          <Tooltip title="Delete"> <IconButton><DeleteIcon /> </IconButton>
          </Tooltip>
        ) : (
